...
class SiteSettings(models.Model):
    ...
    address = models.CharField(max_length=250, verbose_name="آدرس سایت")
    phone = models.CharField(max_length=250, null=True, verbose_name="شماره تلفن سایت")
    fax = models.CharField(max_length=250, null=True, verbose_name="فکس سایت")
    email = models.CharField(max_length=250, null=True, verbose_name="ایمیل سایت")
